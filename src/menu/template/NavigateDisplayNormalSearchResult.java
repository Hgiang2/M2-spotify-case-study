...
public class NavigateDisplayNormalSearchResult implements Navigator{
    ...
    private void displayNormalResult() {
        ...
        for (Artist artist : searchResult.getArtistResult()) menuSearchResult.addMenuItem(new MenuItem(artist.getUsername(), new CommandSelectNormalSpotifyArtist(artist, this)));
